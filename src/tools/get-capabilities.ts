...
export function registerGetCapabilitiesTool(server: McpServer, client: ContentClient): void {
  server.tool(
    ...
    'Read the backend Content Publishing API Contract before creating or updating content. Use this to discover supported content types, locales, content_scope rules (kinds, examples, which types require a scope), and available scopes.',
