...
export function registerListDraftsTool(server: McpServer, client: ContentClient): void {
  server.tool(
    'n2n_list_drafts',
    'List unpublished draft posts. Use this before resuming previous AI-written drafts. This tool always filters status=draft; use type, content_scope, q, and per_page to narrow the results.',
